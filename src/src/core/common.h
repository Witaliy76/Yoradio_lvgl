...
enum displayRequestType_e { BOOTSTRING, NEWMODE, CLOCK, NEWTITLE, NEWSTATION, DRAWVOL, DBITRATE, DSP_START, WAITFORSD, MAIN_BG_FS_UPDATED, ART_FS_UPDATED, SET_THEME_PRESET, CUSTOM_THEME_FILE_UPDATED, REFRESH_MAIN, NOPE };
