...
enum displayRequestType_e { BOOTSTRING, NEWMODE, CLOCK, NEWTITLE, NEWSTATION, DRAWVOL, DBITRATE, AUDIOINFO, DSPRSSI, SHOWWEATHER, NEWWEATHER, PSTOP, PSTART, DSP_START, WAITFORSD, NEWIP, MAIN_BG_FS_UPDATED, ART_FS_UPDATED, SET_THEME_PRESET, CUSTOM_THEME_FILE_UPDATED, NOPE };
