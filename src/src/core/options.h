...
#define YOVERSION "0.9.434m-r2-alpha.s8-E19C2"
...
/*        SPECTRUM ANALYZER (compiled; runtime OFF since 8-E18D — config.store.usespectrum dormant) */
#ifndef SPECTRUM_USE_PSRAM
  #define SPECTRUM_USE_PSRAM     true    // Использовать PSRAM для FFT буферов
#endif
#ifndef SPECTRUM_BANDS
  #define SPECTRUM_BANDS         32      // Количество полос спектра (8-64)
#endif
#ifndef SPECTRUM_FFT_SIZE
  #define SPECTRUM_FFT_SIZE      256     // Размер FFT (128-1024)
#endif
#ifndef SPECTRUM_SMOOTHING
  #define SPECTRUM_SMOOTHING     0.7f    // Сглаживание (0.0-1.0)
#endif
#ifndef SPECTRUM_PEAK_HOLD_TIME
  #define SPECTRUM_PEAK_HOLD_TIME 1000.0f // Время удержания пиков (мс)
#endif
#ifndef SPECTRUM_LOGARITHMIC
