 ...
 * Size: 18 px
 * Bpp: 4
 * Opts: --font G:\Github\Yoradio_RGB_Panel-1\.fontwork\tabler-stripped.ttf --size 18 --bpp 4 --format lvgl --no-compress -o src\src\lvgl_ui\fonts\lv_font_yora_station_icons_18.c -r 60239,61263 --lv-include lvgl.h
 ******************************************************************************/
