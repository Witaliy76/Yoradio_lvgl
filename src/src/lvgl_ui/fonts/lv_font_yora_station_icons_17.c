 ...
 * Size: 17 px
 * Bpp: 4
 * Opts: --font G:\Github\Yoradio_RGB_Panel-1\.fontwork\tabler-stripped.ttf --size 17 --bpp 4 --format lvgl --no-compress -o src\src\lvgl_ui\fonts\lv_font_yora_station_icons_17.c -r 60239,61263 --lv-include lvgl.h
 ******************************************************************************/
...
static LV_ATTRIBUTE_LARGE_CONST const uint8_t glyph_bitmap[] = {
    ...
    0xa2, 0x7, 0xfe, 0xf7, 0xd8, 0xca, 0xaf, 0xdd,
