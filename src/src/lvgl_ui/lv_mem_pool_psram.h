 ...
 *
 * Included from lv_mem_core_builtin.c via LV_MEM_POOL_INCLUDE when YORADIO_LVGL_POOL_IN_PSRAM=1.
 * Подключается из lv_mem_core_builtin.c через LV_MEM_POOL_INCLUDE при YORADIO_LVGL_POOL_IN_PSRAM=1.
